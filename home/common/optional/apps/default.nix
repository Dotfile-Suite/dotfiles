  ...
  sandboxedApps = sandbox.mkSandboxedApps [
    {
      attr = "octaveFull";
      bin = "octave";
    } # note: the statistics/signal forge packages the plain package used to bundle aren't included here; `pkg install -forge ...` them at runtime if needed
    {attr = "kicad";}
    {
      attr = "jetbrains.idea";
      bin = "idea";
    } # good for java 25 development
    {
      attr = "gradle_9";
      bin = "gradle";
    } # ships with its own default JDK (jdk25), no JAVA_HOME needed
    {
      attr = "openjdk25";
      bin = "java";
    }
