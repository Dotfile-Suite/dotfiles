...
MORNING_WALLPAPER="$HOME/.config/hypr/images/tropic_island_morning.jpg"
DAY_WALLPAPER="$HOME/.config/hypr/images/tropic_island_day.jpg"
EVENING_WALLPAPER="$HOME/.config/hypr/images/tropic_island_evening.jpg"
NIGHT_WALLPAPER="$HOME/.config/hypr/images/tropic_island_night.jpg"
