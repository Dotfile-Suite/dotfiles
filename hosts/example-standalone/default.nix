...
# core/user modules only. Copy this directory (bootstrap.sh does this for
# you) to start a real machine, then layer on whatever
# hosts/common/optional modules and hardware config that machine actually
# needs.
{
  pkgs,
  lib,
